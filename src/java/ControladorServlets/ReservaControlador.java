...
public class ReservaControlador extends HttpServlet {
            ...
            ReservaServicio servi = new ReservaServicio(dao);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion.equals("crearReserva")) {
            this.crearReserva(request, response);
        }
    }
        ...
        private void crearReserva(HttpServletRequest request, HttpServletResponse response)
            ...
            reservas.setTipo(request.getParameter("txtTipoR"));
            reservas.setFechaSalida(request.getParameter("txtFechaS"));
            reservas.setFechaEntrada(request.getParameter("txtFechaE"));
            reservas.setUsuario_cedula(Integer.parseInt(request.getParameter("txtUsuarioC")));
            
            
        try{
            response.sendRedirect("crearReserva.jsp"); 
            servi.insert(reservas);
        }catch(Exception e){
            e.printStackTrace();
        }
    }
