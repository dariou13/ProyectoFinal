         ...
         <div id="wrapper">
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a class="active" href="#">Actualizar</a>
                                    </li>
                                    <li>
           ...
           <div id="page-wrapper">
               <div class="container-fluid">
                   <div class="row">
                       <div class="col-lg-12">
                           <h1 class="page-header">Modificar - Actualizar Equipos</h1>
                       </div>
                       <!-- /.col-lg-12 -->
                   </div>                   
                   <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Datos del Equipo a modificar o actualizar
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form role="form" method="post" action="EquipoControlador">
                                                <input type="hidden" name="action" value="ModificarEquipos" />    
                                                 <div class="form-group">
                                                    <label>Id del Equipo a modificar o actualizar</label>
                                                    <input  name="txtIDN" class="form-control">                                                    
                                                    
                                                </div> 
                                                <div class="form-group">
                                                    <label>Nuevo Nombre: </label>
                                                    <input  name="txtNombreN" class="form-control">                                                    
                                                    
                                                </div>                                                
                                                <div class="form-group">
                                                    <label>Nuevo Modelo</label>
                                                    <input  name="txtModeloN" class="form-control">                                                    
                                                </div>                                      
                                                <div class="form-group">
                                                    <label>Nueva Referencia</label>
                                                    <input name="txtReferenciaN" class="form-control">                                                    
                                                </div>                                                
                                                <div class="form-group">
                                                    <label>Nueva Cantidad</label>
                                                    <input name="txtCantidadN" class="form-control">                                                    
                                                </div>                                               
                                                <div class="form-group">
                                                    <label>Nuevo Programa</label>
                                                    <input name="txtProgramaN" class="form-control">                                                    
                                                </div>
                                                <button type="submit" class="btn btn-default">Modificar - Actualizar</button>
